            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb2">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('categories.show', ['slug' => $service->category->slug]) }}">
    ...
    <section id="main-container" class="main-container">
        <div class="container">
            ...
            <div class="col-lg-6 m-auto text-center">
                <h3 class="column-title mrt-0">{{ $service->title }}</h3>
            </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="item">
                    <img loading="lazy" class="img-fluid" src="{{ $service && $service->feature_image ? asset('storage/' . $service->feature_image) : asset('assets/images/projects/Fire-Alarm System.jpg') }}" alt="project-image" />
                </div>
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                ...
                @if (!empty($service->pdf_url))
                    <div>
                        <a class="btn btn-primary" href="{{ $service->pdf_url }}" target="_blank">View PDF</a>
                    </div>
                @else
                    <p></p>
                @endif
