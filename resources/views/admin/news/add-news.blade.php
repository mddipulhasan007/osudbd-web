...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">All/</span> Add New Media & News</h4>

    <!-- Basic Layout & Basic with Icons -->
    <form method="post" action="{{ route('addnewnews') }}" enctype="multipart/form-data">
        ...
        <div class="col-xxl">
          <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h5 class="mb-0">Add Media & News</h5>
