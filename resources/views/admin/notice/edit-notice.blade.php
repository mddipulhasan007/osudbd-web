...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">All/</span> Edit Notice</h4>

    <!-- Basic Layout & Basic with Icons -->
    <form method="post" action="{{ route('editnotice', ['id' => $notice->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        ...
                        <input name="title" type="text" id="basic-icon-default-email" class="form-control" placeholder="Enter Notice Title"
                          aria-label="" aria-describedby="basic-icon-default-email2" value="{{ $notice->title }}" />
                      </div>
                    </div>
                  </div>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        ...
                        <input name="pdf_url" type="text" id="basic-icon-default-email" class="form-control" placeholder="Enter PDF URL"
                          aria-label="" aria-describedby="basic-icon-default-email2" value="{{ $notice->pdf_url }}" />
                      </div>
                    </div>
                  </div>
                  </div>
