...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form method="post" action="{{ route('editbanner', ['id' => $banner->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-merge">
                        ...
                        <input name="caption_title" type="text" id="basic-icon-default-email" class="form-control" placeholder="Slider Text Caption Title"
                          aria-label="caption-title" aria-describedby="basic-icon-default-email2" value="{{ $banner->caption_title }}" />
                      </div>
                    </div>
                  </div>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-merge">
                        ...
                        <input name="main_title" type="text" id="basic-icon-default-email" class="form-control" placeholder="Slider Text Main Title"
                          aria-label="main-title" aria-describedby="basic-icon-default-email2" value="{{ $banner->main_title }}" />
                      </div>
                    </div>
                  </div>
                  <div class="row mb-3">
