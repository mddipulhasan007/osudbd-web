...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home/</span> Add New Brand Logo</h4>

    <!-- Basic Layout & Basic with Icons -->
    <form method="post" action="{{ route('addnewbrandlogo') }}" enctype="multipart/form-data">
