...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">All/</span> Add New Team</h4>

    <!-- Basic Layout & Basic with Icons -->
    <form method="post" action="{{ route('addnewteam') }}" enctype="multipart/form-data">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body img-item-sec">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                        <textarea id="mytextarea" name="short_content">Content here...</textarea>
                  </div>
                </div>
            </div>
          </div>
