...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">All/</span> Add Product Type </h4>

    <!-- Basic Layout & Basic with Icons -->
    <h2>Add Type</h2>

    <form method="post" action="{{ route('addproducttype') }}" enctype="multipart/form-data">
        @csrf

        <div class="form-group row mb-5">
            <label class="col-sm-2 col-form-label" for="name">Type Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="name" placeholder="Enter product type name" required>
            </div>
        </div>
