                  ...
                  <div class="col-sm-10">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="title" type="text" id="basic-icon-default-email" class="form-control" placeholder="The Title"
                        aria-label="the title" aria-describedby="basic-icon-default-email2" value="{{ $project->title }}" />
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-12">
                        <textarea id="mytextarea" name="content">{{ $project->content }}</textarea>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <div class="input-group input-group-merge">
                      ...
                      <input name="pdf_url" type="text" id="basic-icon-default-email" class="form-control" placeholder="www.pdfurl.com/abcdef"
                        aria-label="www.pdfurl.com/abcdef" aria-describedby="basic-icon-default-email2" value="{{ $project->pdf_url }}" />
                    </div>
                  </div>
                </div>
                <div class="row mb-3">
